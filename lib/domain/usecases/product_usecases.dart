...
class GetUserProductsUsecase extends Usecase<Result, ProductParams> {
  GetUserProductsUsecase(this._productRepository);

  final ProductRepository _productRepository;

  @override
  Future<Result<List<ProductEntity>>> call(ProductParams params) async => _productRepository.getUserProducts(
    params.param,
